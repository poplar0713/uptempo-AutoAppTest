...
public class BaseSetting {
	...
	public void setup(String deviceName, String udid, String systemPort, String appPackage, String appActivity)
			throws IOException {
		...
		// capabilitiesUtil.setCapability("app",
		// "D:\\appium\\signed_KT_GiGAGenie4_3.3.3(170)_211001-GoogleStore-release.apk");
