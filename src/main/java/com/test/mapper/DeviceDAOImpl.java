...
//		System.out.println(deviceName);
		...
		DeviceDto device = mongoTemplate.findOne(Query.query(Criteria.where("deviceName").is(deviceName)),
				DeviceDto.class);
	...
	public AppInfoDto appInfoCheck(String appEnName) {
		...
		// Query query= new Query(new Criteria("deviceName").is(deviceName));
		// System.out.println(query);
		AppInfoDto app = mongoTemplate.findOne(Query.query(Criteria.where("appEnName").is(appEnName)),
				AppInfoDto.class);
	...
	public ReserveInfoDto checkTheTime(String reservedTime) {
		...
		ReserveInfoDto work = mongoTemplate.findOne(Query.query(Criteria.where("reservedTime").is(reservedTime)),
				ReserveInfoDto.class);
